  ...
  return (
    <div className='h-screen w-screen flex'>
     ...
     <div className='bg-red-100 px-2 py-4'>
      ...
      <div className='w-3/4 bg-red-50 flex flex-col'>
      <div className='flex-grow'>
        <div className='flex-grow bg-red-400 flex justify-between px-3 py-3 flex items-center'>
      ...
      <div className='flex gap-3 p-4'> 
         <div className='flex items-center bg-red-200 p-2 rounded-md'>
         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
         <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
        </svg>
         </div>
        <input 
          className='flex-grow rounded-md outline-none placeholder-gray-500 placeholder-opacity-75 px-2'
